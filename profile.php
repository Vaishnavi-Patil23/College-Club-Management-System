...
<head>
  ...
  <meta content="width=device-width, initial-scale=1.0" n
  e="viewport">
  ...
  <div id="home" class="intro route bg-image" style="background-image: url(images/AdminBuilding.jpg);background-size: cover; ">
    ...
    if (mysqli_num_rows($run)==0){
      ...
      <div class='table-cell'>
        <div class='container'>
          <h1 class='intro-title mb-4'>No Upcoming Events</h1>
      ...
      <div class='table-cell'>
        <div class='container'>
          <p class='display-6 color-d'>Event Date :15 March 2024 <b>Time :</b>10:00 </p>
              ...
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
                    ...
                    <div class="w-more">
                      <span class="w-ctegory">Gandharv Drama Club</span> 
                    </div>
                  </div>
          ...
          <div class="col-sm-12">
            <div class="copyright-box">
              <div class="credits">
                ...
                You're always welcome to be a part of Event and Clubs of SGGS </a>
              </div>
            </div>
          </div>
        </div>
