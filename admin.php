...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="performerdetail.php">Student Detail</a>
          </li>
          <li class="nav-item">
            <a class="nav-link js-scroll" href="coachdetail.php">Co-ordinator detail</a>
          </li>
           <li class="nav-item">
            <a class="nav-link js-scroll" href="registration/workshop.php">Add Event</a>
          </li>
          <li class="nav-item">
  ...
  <div id="home" class="intro route bg-image" style="background-image: url(images/AdminBuilding.jpg);background-size: cover; ">
    ...
    <?php
      ...
      $sql="SELECT * FROM workshop WHERE wshow='5'";
      $run=mysqli_query($con,$sql);
    if (mysqli_num_rows($run)==0){
          echo "<div class='intro-content display-table'>
      <div class='table-cell'>
        <div class='container'>
          <h1 class='intro-title mb-4'>EVENT MANAGEMENT</h1>
          <p class='intro-subtitle'><span class='text-slider-items'>Lets see who are INTERESTED</span><strong class='text-slider'></strong></p>
        </div>
      </div>
    </div>";
      }else{
