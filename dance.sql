...
(2, 'PRAGYA', '2024-03-15', 'AUDITORIUM', 1, 'INTER-DEPARTMENT FEST', '10 AM'),
(4, 'QUIZ','2023-01-20','C block- 2nd floor',0,'OFF-STAGE EVENTS','9:00 am');
(5, 'PRAGYA', '2024-03-15', 'AUDITORIUM', 5, 'INTER-DEPARTMENT FEST', '10 AM'),

-- Triggers for `workshop`
DELIMITER $$
...
ALTER TABLE `admin` ADD PRIMARY KEY (`aid`);
-- Indexes for table `coach`
ALTER TABLE `coach` ADD PRIMARY KEY (`cid`);
-- Indexes for table `performer`
ALTER TABLE `performer` ADD PRIMARY KEY (`pid`);
-- Indexes for table `workshop`
ALTER TABLE `workshop` ADD PRIMARY KEY (`wid`);

-- AUTO_INCREMENT for dumped tables
-- AUTO_INCREMENT for table `admin`
ALTER TABLE `admin` MODIFY `aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
-- AUTO_INCREMENT for table `coach`
ALTER TABLE `coach` MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
-- AUTO_INCREMENT for table `performer`
ALTER TABLE `performer` MODIFY `pid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
-- AUTO_INCREMENT for table `workshop`
ALTER TABLE `workshop` MODIFY `wid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
